...
module.exports = (bluebird, error, logger, requestOptions, requestPromise, responseHandler, ShelfError) => {
    /**
    ...
    class Metadata {
         ...
         *
         * @return {Promise.<metadataValues>|ShelfError}
         */
        getAll() {
            var options;
         ...
         * @return {Promise.<metadataProperty>|ShelfError}
         */
        getProperty(name) {
            var options;
         ...
         * @return {Promise.<Object>|ShelfError}
         */
        deleteProperty(name) {
            var options;
