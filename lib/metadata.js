...
module.exports = (bluebird, error, ExtendedError, logger, requestOptions, requestPromise, responseHandler) => {
    /**
    ...
    class Metadata {
        ...
        getProperty(name) {
            ...
            if (!name) {
                return bluebird.reject(new ExtendedError("Must provide the name for the property to get.", error.INCORRECT_PARAMETERS));
            }
        ...
        updateAll(metadata) {
            ...
            if (!metadata) {
                return bluebird.reject(new ExtendedError("Must provide metadata to update.", error.INCORRECT_PARAMETERS));
            }
        ...
        updateProperty(name, property) {
            ...
            if (!name) {
                return bluebird.reject(new ExtendedError("Must provide the name for the property to update.", error.INCORRECT_PARAMETERS));
            }
        ...
        createProperty(name, property) {
            ...
            if (!name) {
                return bluebird.reject(new ExtendedError("Must provide a name for the property to create.", error.INCORRECT_PARAMETERS));
            }

            if (!property) {
                return bluebird.reject(new ExtendedError("Must provide the property data to set.", error.INCORRECT_PARAMETERS));
            }
        ...
        deleteProperty(name) {
            ...
            if (!name) {
                return bluebird.reject(new ExtendedError("Must provide the name for the property to delete.", error.INCORRECT_PARAMETERS));
            }
