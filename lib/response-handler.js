...
module.exports = (error, logger, parseLinkHeader) => {
     ...
     * @property {string} statusCode The HTTP status code.
     * @property {string} message The status message for the response.
     * @property {Object} body The response body.
     * @property {string} location The url of the uploaded artifact.
     */
    ...
    function handleArtifactResponse(response) {
        ...
        if (artifactResponse.statusCode === 201) {
            ...
            artifactResponse.location = response.headers.location;
     ...
     * @property {string} statusCode The HTTP status code.
     * @property {string} message The status message of the response.
     * @property {Object} body On a put/post/get, this will contain the
     *                         metadata, or metadata property.
     */
