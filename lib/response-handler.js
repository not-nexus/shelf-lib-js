...
module.exports = (bluebird, error, logger, parseLinkHeader, URI) => {
    /**
     * Checks if the response status code is less than 200 or if it is
     * greater than 399
     *
    ...
    /**
     * Handles errors. Check if under 200, or greater than
     * 399. Map error. Throw exception. This is in common with
     * ALL endpoints.
     *
