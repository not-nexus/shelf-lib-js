...
module.exports = (logger, requestPromise, utils) => {
    /**
    ...
    class ShelfMetadata {
        ...
        /**
         * Updates the file's metadata. Only updates mutable items.
         *
        ...
        /**
         * Updates the file's metadata. Only updates mutable items.
         * Due to the nature of the Shelf API, this will create the property
         * if it doesn't exist.
         *
        ...
        deleteProperty(property) {
            ...
            return requestPromise.delete(options)(options).then((response) => {
