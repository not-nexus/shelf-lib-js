...
module.exports = (host, libOptions) => {
    var Artifact, ArtifactSearch, dateService, error, logger, Metadata, parseLinkHeader, Reference, requestOptions, requestPromise, responseHandler, shelfLib, URI;
    ...
    URI = require("urijs");
    requestOptions = require("./request-options")(libOptions, logger);
    responseHandler = require("./response-handler")(error, logger, parseLinkHeader);
